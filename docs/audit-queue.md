...
EOA transaction-fencing regressions and bounded fixes are in progress. Queue production code remains unchanged for baseline measurement. No live-chain throughput or production finality claim has been established.
